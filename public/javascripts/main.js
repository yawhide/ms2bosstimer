...
function init(){
  ...
  var sallyNextSpawn = TIMERS.sally ? TIMERS.sally.time : 1000
  var oneeyeNextSpawn = TIMERS.oneeye ? TIMERS.oneeye.time : 1000
  var robotNextSpawn = TIMERS.robot ? TIMERS.robot.time : 1000
